...
int is_valid_length(char *localport) {
    ...
    if (GENERAL_YAHOO_MIN_LENGTH <= length &&
        length <= GENERAL_YAHOO_MAX_LENGTH)
        return 0;
    else {
        return 1;
    }
